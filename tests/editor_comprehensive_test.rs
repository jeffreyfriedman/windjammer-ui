...
fn test_scene_serialization() {
    use windjammer_ui::scene_manager::{Scene, SceneMode, SceneObject, Vec3};
...
fn test_all_object_types() {
    use windjammer_ui::scene_manager::{Color, ObjectType, SceneObject, Vec3};
