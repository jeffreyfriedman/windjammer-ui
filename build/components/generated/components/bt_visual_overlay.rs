...
pub fn bt_editor_layout_stub() -> String {
    "".to_string().to_string() + &"<div class=\"bt-shell\">".to_string() + &"<header style=\"padding:14px;border-bottom:1px solid rgba(255,255,255,0.08)\">Windjammer · Visual Behavior Tree Shell</header>".to_string() + &"<div class=\"bt-shell-body\">{{PALETTE}}</div>".to_string() + &"{{DEBUG}}".to_string() + &"</div>".to_string()
}
