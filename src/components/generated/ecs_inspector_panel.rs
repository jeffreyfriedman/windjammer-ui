...
pub fn from_mock() -> EcsInspectorPanel {
        EcsInspectorPanel { snapshot: EcsInspectorSnapshot::mock_runtime_demo(), refresh_handler: "ecs_inspector_refresh()".to_string(), select_entity_handler: "ecs_inspector_select_entity".to_string() }
}
#[inline]
pub fn empty() -> EcsInspectorPanel {
        EcsInspectorPanel { snapshot: EcsInspectorSnapshot::empty(), refresh_handler: "ecs_inspector_refresh()".to_string(), select_entity_handler: "ecs_inspector_select_entity".to_string() }
}
#[inline]
