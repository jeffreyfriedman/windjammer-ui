...
impl NodePin {
    ...
    pub fn input(id: String, name: String, pin_type: PinType) -> NodePin {
        NodePin {
            ...
            is_input: true,
            connected_to: None,
            default_value: "".to_string().to_string(),
        }
    }
    #[inline]
    ...
    pub fn get_color(&self) -> String {
        match self.pin_type {
            PinType::Flow => "#ffffff".to_string().to_string(),
            PinType::Bool => "#e94560".to_string().to_string(),
            PinType::Int => "#00d9ff".to_string().to_string(),
            PinType::Float => "#4ade80".to_string().to_string(),
            PinType::Vec2 => "#facc15".to_string().to_string(),
            PinType::Vec3 => "#f59e0b".to_string().to_string(),
            PinType::Vec4 => "#a855f7".to_string().to_string(),
            PinType::Color => "#ec4899".to_string().to_string(),
            PinType::Texture => "#fb923c".to_string().to_string(),
            PinType::Object => "#3b82f6".to_string().to_string(),
            PinType::Any => "#888888".to_string().to_string(),
        }
    }
}
...
impl GraphNode {
    ...
    pub fn get_category_color(&self) -> String {
        match self.category {
            NodeCategory::Math => "#4ade80".to_string().to_string(),
            NodeCategory::Logic => "#e94560".to_string().to_string(),
            NodeCategory::Texture => "#fb923c".to_string().to_string(),
            NodeCategory::Color => "#ec4899".to_string().to_string(),
            NodeCategory::Vector => "#facc15".to_string().to_string(),
            NodeCategory::Flow => "#ffffff".to_string().to_string(),
            NodeCategory::Event => "#3b82f6".to_string().to_string(),
            NodeCategory::Variable => "#a855f7".to_string().to_string(),
            NodeCategory::Custom => "#888888".to_string().to_string(),
        }
    }
}
