...
pub fn new(id: String, title: String, category: NodeCategory) -> GraphNode {
        GraphNode { id, title, category, x: 0.0_f32, y: 0.0_f32, inputs: Vec::new(), outputs: Vec::new(), collapsed: false, preview_enabled: false, trace_active: false, pin_watch_text: "".to_string() }
}
#[inline]
...
fn render(self) -> String {
        ...
        for pin in self.inputs {
            ...
            let connected_class: String = match pin.connected_to {
        ...
        let preview_html = {
            if self.preview_enabled {
                String::from("<div class='node-preview'><canvas class='preview-canvas'></canvas></div>")
            } else {
                String::new()
            }
        };
...
pub fn new() -> NodeGraph {
        NodeGraph { width: 800_i32, height: 600_i32, nodes: Vec::new(), connections: Vec::new(), zoom: 1.0_f32, pan_x: 0.0_f32, pan_y: 0.0_f32, show_grid: true, on_change: "".to_string(), trace_node_ids: Vec::new() }
}
