...
fn render(&self) -> String {
        let style = {
            ...
            write!(&mut __s, "padding: {}; background-color: {}; border: 1px solid {}; border-radius: 8px;", self.padding.clone(), self.background_color.clone(), self.border_color.clone()).unwrap();
            __s
        };
        let title_html = {
            if self.title != "" {
