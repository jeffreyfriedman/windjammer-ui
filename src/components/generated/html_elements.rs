...
#[inline]
pub fn new() -> Div {
        Div { children: Vec::new(), class: String::new(), style: String::new(), id: String::new() }
}
#[inline]
...
#[inline]
pub fn new() -> Span {
        Span { children: Vec::new(), class: String::new(), style: String::new() }
}
#[inline]
...
#[inline]
pub fn new() -> P {
        P { children: Vec::new(), class: String::new(), style: String::new() }
}
#[inline]
...
pub fn new(text: String) -> H1 {
        H1 { text: text.to_string(), class: String::new(), style: String::new() }
}
#[inline]
...
pub fn new(text: String) -> H2 {
        H2 { text: text.to_string(), class: String::new(), style: String::new() }
}
#[inline]
...
pub fn new(text: String) -> H3 {
        H3 { text: text.to_string(), class: String::new(), style: String::new() }
}
#[inline]
