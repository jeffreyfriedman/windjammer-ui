...
pub fn patrol_demo() -> BtCanvasModel {
        ...
        nodes.push(BtCanvasNode { editor_id: 1_i32, title: "Root".to_string(), subtitle: "sequence".to_string(), accent: "#4c6ef5".to_string(), cx: 360_i32, cy: 48_i32, debug_class: "bt-visual-success".to_string() });
        nodes.push(BtCanvasNode { editor_id: 2_i32, title: "patrol".to_string(), subtitle: "action".to_string(), accent: "#2f9e44".to_string(), cx: 140_i32, cy: 168_i32, debug_class: "bt-visual-success".to_string() });
        nodes.push(BtCanvasNode { editor_id: 3_i32, title: "is_enemy_near".to_string(), subtitle: "condition".to_string(), accent: "#f08c00".to_string(), cx: 360_i32, cy: 168_i32, debug_class: "bt-visual-success".to_string() });
        nodes.push(BtCanvasNode { editor_id: 4_i32, title: "chase".to_string(), subtitle: "action".to_string(), accent: "#2f9e44".to_string(), cx: 580_i32, cy: 168_i32, debug_class: "bt-visual-success".to_string() });
        nodes.push(BtCanvasNode { editor_id: 5_i32, title: "attack".to_string(), subtitle: "action".to_string(), accent: "#2f9e44".to_string(), cx: 800_i32, cy: 168_i32, debug_class: "bt-visual-running".to_string() });
        let mut wires: Vec<BtWire> = Vec::new();
        wires.push(BtWire { from_id: 1_i32, to_id: 2_i32 });
        wires.push(BtWire { from_id: 1_i32, to_id: 3_i32 });
        wires.push(BtWire { from_id: 1_i32, to_id: 4_i32 });
        wires.push(BtWire { from_id: 1_i32, to_id: 5_i32 });
        BtCanvasModel { nodes, wires, zoom: 1.0_f32, pan_x: 0.0_f32, pan_y: 12.0_f32 }
}
}
...
fn render(self) -> String {
        ...
        while w < self.wires.len() {
            ...
            svg_paths = format!("{}<path class='bt-wire' data-from=\"{}\" data-to=\"{}\" />", svg_paths, edge.from_id, edge.to_id);
            w += 1;
        }
