...
#[inline]
pub fn new() -> Flex {
        Flex { children: Vec::new(), direction: FlexDirection::Row, gap: "8px".to_string(), padding: "".to_string(), background_color: "".to_string() }
}
#[inline]
...
fn render(&self) -> String {
        ...
        let mut style = format!("{}{}{}{}{}", "display: flex; flex-direction: ", direction_str, "; gap: ", self.gap.clone(), ";");
        if self.padding != "" {
            style = format!("{}{}{}{}", style, " padding: ", self.padding.clone(), ";");
        }
        if self.background_color != "" {
            style = format!("{}{}{}{}", style, " background-color: ", self.background_color.clone(), ";");
        }
