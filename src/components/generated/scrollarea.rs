...
pub fn new() -> ScrollArea {
        ScrollArea { children: Vec::new(), direction: ScrollDirection::Vertical, height: "300px".to_string(), width: "100%".to_string() }
}
#[inline]
...
fn render(&self) -> String {
        ...
        format!("<div class='wj-scroll-area' style='height: {}; width: {}; {}'>\n  {}\n</div>", self.height.clone(), self.width.clone(), overflow_style, children_html)
}
}
