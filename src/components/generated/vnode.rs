...
impl VNode {
    ...
    pub fn set_id(self, id: &str) -> VNode {
        vnode_ffi::vnode_attr(self.handle, "id".to_string(), id);
        self
    }
    /// Set placeholder (for inputs)
    #[inline]
    pub fn set_placeholder(self, text: &str) -> VNode {
        vnode_ffi::vnode_attr(self.handle, "placeholder".to_string(), text);
        self
    }
    /// Set type attribute (for inputs/buttons)
    #[inline]
    pub fn set_type(self, t: &str) -> VNode {
        vnode_ffi::vnode_attr(self.handle, "type".to_string(), t);
        self
    }
    /// Set value attribute
    #[inline]
    pub fn set_value(self, v: &str) -> VNode {
        vnode_ffi::vnode_attr(self.handle, "value".to_string(), v);
        self
    }
