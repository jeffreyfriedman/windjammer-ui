...
pub fn inactive() -> FrameDebuggerPanel {
        FrameDebuggerPanel { state: FrameDebuggerViewState::empty(), step_back_handler: String::from("frame_debug_step_back()"), step_forward_handler: String::from("frame_debug_step_forward()"), capture_handler: String::from("frame_debug_capture()") }
}
#[inline]
pub fn from_mock() -> FrameDebuggerPanel {
        FrameDebuggerPanel { state: FrameDebuggerViewState::mock_captured(), step_back_handler: String::from("frame_debug_step_back()"), step_forward_handler: String::from("frame_debug_step_forward()"), capture_handler: String::from("frame_debug_capture()") }
}
#[inline]
pub fn from_live() -> FrameDebuggerPanel {
        ...
        let state = FrameDebuggerViewState::from_trace(frame_trace_ffi::live_frame_index(), frame_trace_ffi::live_frame_count() as usize, frame_trace_ffi::live_frame_time_ms(), frame_trace_ffi::live_can_step_back(), frame_trace_ffi::live_can_step_forward());
        FrameDebuggerPanel { state, step_back_handler: String::from("frame_debug_step_back()"), step_forward_handler: String::from("frame_debug_step_forward()"), capture_handler: String::from("frame_debug_capture()") }
}
#[inline]
