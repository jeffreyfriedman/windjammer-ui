...
#[inline]
pub fn new() -> Navbar {
        Navbar { brand: String::from(""), items: Vec::new(), position: NavbarPosition::Top, sticky: false }
}
#[inline]
...
fn render(self) -> String {
        ...
        for item in &self.items {
            items_html.push(format!("<a href='{}' class='wj-navbar-item'>{}</a>", item.href.clone(), item.label.clone()));
        }
