...
use crate::event_handler::ColorEventHandler;
...
pub struct ColorPicker {
    ...
    pub show_alpha: bool,
    pub on_change: Option<ColorEventHandler>,
}
    ...
    pub fn render(&self) -> VNode {
        ...
        let preview = VNode::Element {
            ...
            attrs: vec![
                (
                    "class".to_string(),
                    VAttr::Static("wj-color-preview".to_string()),
                ),
                (
                    "style".to_string(),
                    VAttr::Static(format!(
        ...
        let hex_input = VNode::Element {
            ...
            attrs: vec![
                ...
                (
                    "class".to_string(),
                    VAttr::Static("wj-color-hex".to_string()),
                ),
                (
                    "style".to_string(),
                    VAttr::Static(
                        "background: #3C3C3C; color: #D4D4D4; border: 1px solid #3E3E3E; \
                         ...
                         font-family: monospace; width: 80px; margin-left: 8px;"
                            .to_string(),
                    ),
                ),
            ],
        ...
        let preview_row = VNode::Element {
            ...
            attrs: vec![
                (
                    "class".to_string(),
                    VAttr::Static("wj-color-picker-header".to_string()),
                ),
                (
                    "style".to_string(),
                    VAttr::Static(
                        "display: flex; align-items: center; margin-bottom: 8px;".to_string(),
                    ),
                ),
            ],
        ...
        VNode::Element {
            ...
            attrs: vec![
                (
                    "class".to_string(),
                    VAttr::Static("wj-color-picker".to_string()),
                ),
                (
                    "style".to_string(),
                    VAttr::Static(
    ...
    fn render_rgb_sliders(&self) -> VNode {
        ...
        VNode::Element {
            ...
            attrs: vec![
                (
                    "class".to_string(),
                    VAttr::Static("wj-color-rgb-sliders".to_string()),
                ),
                (
                    "style".to_string(),
    ...
    fn render_channel_slider(&self, label: &str, value: f32, color: &str) -> VNode {
        let label_node = VNode::Element {
            ...
            attrs: vec![
                ...
                (
                    "style".to_string(),
                    VAttr::Static(
                        "font-size: 12px; color: #9D9D9D; width: 20px; font-weight: 500;"
                            .to_string(),
                    ),
                ),
            ],
        ...
        VNode::Element {
            ...
            attrs: vec![
                (
                    "class".to_string(),
                    VAttr::Static("wj-slider-row".to_string()),
                ),
                (
                    "style".to_string(),
    ...
    fn render_alpha_slider(&self) -> VNode {
        ...
        let slider = VNode::Element {
            ...
            attrs: vec![
                ...
                (
                    "value".to_string(),
                    VAttr::Static(value_percent.to_string()),
                ),
                ("class".to_string(), VAttr::Static("wj-slider".to_string())),
                (
                    "style".to_string(),
        ...
        VNode::Element {
            ...
            attrs: vec![
                ...
                (
                    "style".to_string(),
                    VAttr::Static(
                        "display: flex; align-items: center; margin-top: 8px;".to_string(),
                    ),
                ),
            ],
            children: vec![label_node, slider, value_text],
...
mod tests {
    ...
    fn test_color_picker_show_alpha() {
        let picker = ColorPicker::new([1.0, 1.0, 1.0, 1.0]).show_alpha(false);
        assert!(!picker.show_alpha);
    }
    ...
    fn test_color_picker_no_alpha() {
        let picker = ColorPicker::new([1.0, 0.0, 0.0, 1.0]).show_alpha(false);
        let vnode = picker.render();
