...
impl ScrollArea {
    ...
    pub fn render(&self) -> VNode {
        ...
        style.push_str("scrollbar-width: thin; scrollbar-color: #3E3E3E #1E1E1E;");
        ...
        VNode::Element {
            ...
            attrs: vec![
                (
                    "class".to_string(),
                    VAttr::Static("wj-scroll-area".to_string()),
                ),
        ...
        match vnode {
            VNode::Element {
                ...
                assert!(attrs.iter().any(|(key, attr)| {
                    key == "style"
                        && matches!(attr, VAttr::Static(v) if v.contains("max-height: 300px"))
                }));
            }
